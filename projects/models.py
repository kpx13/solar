...
class Project(models.Model):
    ...
    title = models.CharField(max_length=200, blank=True, verbose_name=u'заголовок рус')
    title_en = models.CharField(max_length=200, blank=True, verbose_name=u'заголовок eng')
    ...
    content = RichTextField(blank=True, null=True, verbose_name=u'контент рус')
    content_en = RichTextField(blank=True, null=True, verbose_name=u'контент eng')
